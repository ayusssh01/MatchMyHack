...
const Navbar = () => {
    ...
    return (
        <header className='w-full relative p-5 text-center '>
            <div className="fixed w-full z-20 top-0 start-0 border-b border-gray-200 bg-opacity-15 dark:border-gray-600 backdrop-blur-lg  dark:opacity-70" style={{ opacity: 1}}>
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <Link href={"/"} className="flex items-center space-x-3 rtl:space-x-reverse" >
                        <div className=' w-10 h-10 grid place-items-center p-1 '>
                            <Image src={Logo} alt="Match MyHack" width={20} height={20} className=' w-full h-full object-cover ' />
                        </div>
                        
                        <span className="self-center text-lg lg:text-2xl font-semibold whitespace-nowrap dark:text-white">Match MyHack</span>
                    </Link>
                    ...
                    <Sheet>
                        ...
                        <div className=' w-full flex flex-col gap-2 items-center justify-center'>
                            <div className=' w-full flex items-center justify-center gap-2 '>
                                <Link href="https://github.com/ayusssh01/MatchMyHack" target="_blank" rel="noopener noreferrer">
                                    <Button variant="outline" className=' flex justify-center items-center gap-2 w-full ' >
                                        <IoLogoGithub />
                                        Github
                                    </Button>
                                </Link>
                                <Link href="mailto:jhaayush52411@gmail.com" target="_blank" rel="noopener noreferrer">
                                    <Button variant="outline" className=' flex justify-center items-center gap-2 w-full ' >
                                        <MdEmail />
                                        Support
                                    </Button>
