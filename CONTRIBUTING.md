...
### 1. Reporting Bugs
- Ensure the issue was not already reported by searching [existing issues](https://github.com/ayusssh01/MatchMyHack/issues).
...
- Check if the enhancement is already proposed in [existing issues](https://github.com/ayusssh01/MatchMyHack/issues).
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/ayusssh01/MatchMyHack
   cd MatchMyHack
